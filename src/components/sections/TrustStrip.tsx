...
/**
 * TrustStrip: single-line reassurance band that anchors the "we sit on top
...
export default function TrustStrip() {
  return (
    <section
      aria-label="Works alongside the platforms you already use"
      className="relative border-y border-border-subtle bg-surface"
    >
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
        <div className="flex flex-col items-center gap-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-text-muted">
            Works alongside the platforms you already run
          </p>
